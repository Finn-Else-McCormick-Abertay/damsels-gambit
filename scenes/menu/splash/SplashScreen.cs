...
public partial class SplashScreen : Control
{
    ...
    public override void _Ready() {
        ...
        var colorRect = new ColorRect() { Color = ProjectSettings.GetSettingWithOverride("application/boot_splash/bg_color").AsColor() };
        AddChild(colorRect);
        ...
        if (ProjectSettings.GetSettingWithOverride("application/boot_splash/show_image").AsBool()) {
            ...
            var textureRect = new TextureRect() { Texture = bootSplashImage, ExpandMode = TextureRect.ExpandModeEnum.IgnoreSize, StretchMode = TextureRect.StretchModeEnum.KeepAspectCentered };
